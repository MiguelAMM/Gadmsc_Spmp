...
public class EquipoFechaFacade extends AbstractFacade<EquipoFecha> implements EquipoFechaServicio {
    ...
    public List<Object[]> listarEquipoTransporte(Integer dia, Integer mes, Integer anio, Integer dia2, Integer mes2, Integer anio2) {
        ...
        consulta.append("select q.eq_tipo, b.eq_fecha_combustible, b.eq_fecha_km_entrada, b.eq_fecha_km_salida, b.eq_fecha_observacion, b.eq_fecha_actividad, CONCAT(a.fecha_tr_dia, '/', a.fecha_tr_mes, '/', a.fecha_tr_anio)  ");
    ...
    public List<Object[]> listarEquipoTransporte(Integer numEquipo, Integer dia, Integer mes, Integer anio, Integer dia2, Integer mes2,
            Integer anio2) {
        StringBuilder consulta = new StringBuilder();
        consulta.append("select q.eq_tipo, b.eq_fecha_combustible, b.eq_fecha_km_entrada, b.eq_fecha_km_salida, b.eq_fecha_observacion, b.eq_fecha_actividad, "
